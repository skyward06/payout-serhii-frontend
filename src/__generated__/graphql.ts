...
export type Member = {
  ...
  communications?: Maybe<Array<EmailRecipient>>;
...
export type QueryEmailRecipientArgs = {
  data: IdInput;
};
...
export type EmailRecipientQueryVariables = Exact<{
  data: IdInput;
}>;


export type EmailRecipientQuery = { __typename?: 'Query', emailRecipient: { __typename?: 'EmailRecipient', id: string, body: string, email: string, sender: string, status: EmailStatus, sentAt?: any | null, subject: string, openedAt?: any | null, senderName: string } };
