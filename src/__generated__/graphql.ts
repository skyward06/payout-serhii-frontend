...
export type BasicMember = {
  ...
  sponsorRefunded: Scalars['Boolean']['output'];
...
export type CreateCampaignInput = {
  emailRegionId?: InputMaybe<Scalars['String']['input']>;
...
export type CreatePostInput = {
  ...
  metaTags?: InputMaybe<Array<Scalars['String']['input']>>;
...
export type EmailRecipient = {
  ...
  createdAt: Scalars['DateTimeISO']['output'];
  emailRegion?: Maybe<EmailRegion>;
  emailRegionId?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  ...
  status: EmailStatus;
  subject: Scalars['String']['output'];
  unsubscribedAt?: Maybe<Scalars['DateTimeISO']['output']>;
};
...
export type EmailRegion = {
  __typename?: 'EmailRegion';
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
...
export type EmailRegionInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  region: Scalars['String']['input'];
};

export type EmailRegionWithUnsubscribe = {
  __typename?: 'EmailRegionWithUnsubscribe';
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  region: Scalars['String']['output'];
...
export type GiftReport = {
  ...
  usedBy: Scalars['String']['output'];
  username: Scalars['String']['output'];
};

export type GiftReportResponse = {
  __typename?: 'GiftReportResponse';
  giftReports: Array<GiftReport>;
  total?: Maybe<Scalars['Int']['output']>;
};
...
export type Mutation = {
  ...
  createPlaidLinkToken: PlaidLinkTokenResponse;
  createPost: Post;
  ...
  exchangePlaidPublicToken: PlaidExchangeTokenResponse;
  ...
  moveToBan: Member;
  moveToBlocked: Member;
  moveToGraveyard: Member;
  moveToPaid: Member;
  ...
  unpublishPost: Post;
  unschedulePost: Post;
  unsubscribeEmailRegion: SuccessResponse;
  updateACH: Ach;
...
export type MutationCreateEmailRegionArgs = {
  data: EmailRegionInput;
};
...
export type MutationMarkRefundedArgs = {
  data: RefundMarkMemberInput;
};
...
export type MutationRemoveEmailRegionArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationSubmitOrderAchPaymentWithPlaidArgs = {
  data: OrderAchSubmitWithPlaidInput;
};


export type MutationSubscribeEmailRegionArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUnsubscribeEmailRegionArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpdateEmailRegionArgs = {
  data: UpdateEmailRegionInput;
};
...
export type OrderAchSubmitWithPlaidInput = {
  checkNumber?: InputMaybe<Scalars['String']['input']>;
  name: Scalars['String']['input'];
  orderId: Scalars['String']['input'];
  /** Plaid access token from exchangePlaidPublicToken */
  plaidAccessToken: Scalars['String']['input'];
  /** Plaid account ID selected by user */
...
export type PaymentMethodPackageRule = {
  __typename?: 'PaymentMethodPackageRule';
  createdAt?: Maybe<Scalars['DateTimeISO']['output']>;
  deletedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  id: Scalars['ID']['output'];
...
export enum PermissionType {
  ...
  EmailRegionEdit = 'EMAIL_REGION_EDIT',
  ...
  PaymentMethodView = 'PAYMENT_METHOD_VIEW',
...
export type PlaidAccountWithNumbers = {
  __typename?: 'PlaidAccountWithNumbers';
  ...
  /** Detailed verification insights from Database Auth */
  verificationInsights?: Maybe<PlaidVerificationInsights>;
  /** Database Auth verification status: database_insights_pass, database_insights_pass_with_caution, or database_insights_fail */
  verificationStatus?: Maybe<Scalars['String']['output']>;
  wireRouting?: Maybe<Scalars['String']['output']>;
};

export type PlaidExchangeTokenResponse = {
  __typename?: 'PlaidExchangeTokenResponse';
  accessToken: Scalars['String']['output'];
  accounts: Array<PlaidAccountWithNumbers>;
...
export type PlaidVerificationInsights = {
  __typename?: 'PlaidVerificationInsights';
  /** Account number format validation */
  accountNumberFormat?: Maybe<Scalars['String']['output']>;
  /** Name match score (0-100) */
  nameMatchScore?: Maybe<Scalars['Float']['output']>;
  /** Network status from Database Auth */
  networkStatus?: Maybe<Scalars['String']['output']>;
  /** Previous returns status */
  previousReturns?: Maybe<Scalars['String']['output']>;
};

export type Post = {
  __typename?: 'Post';
  _id: Scalars['String']['output'];
  _updatedAt: Scalars['DateTimeISO']['output'];
  content: Scalars['String']['output'];
  coverImage?: Maybe<CoverImage>;
  description: Scalars['String']['output'];
  metaDescription: Scalars['String']['output'];
  metaKeywords: Array<PostMetaKeyword>;
  metaTags: Array<PostMetaTag>;
...
export enum PostStatus {
  Draft = 'DRAFT',
  Published = 'PUBLISHED',
  ScheduledDraft = 'SCHEDULED_DRAFT'
}

export type PostStatusData = {
  __typename?: 'PostStatusData';
...
export type Query = {
  ...
  adminPaymentMethods: Array<PaymentMethod>;
  ...
  emailRegions: Array<EmailRegion>;
  emailRegionsByMemberId: Array<EmailRegionWithUnsubscribe>;
  /** For member */
  emailRegionsWithUnsubscribe: Array<EmailRegionWithUnsubscribe>;
  emailSystemOverview: EmailOverview;
  emailTemplateById: EmailTemplate;
  emailTemplates: EmailTemplateResponse;
  enrollmentPaymentMethods: Array<PaymentMethod>;
  events: Array<Event>;
  ...
  memberMe: Member;
  memberStatisticWalletsByDate: Array<MemberStatisticsWallet>;
  ...
  paymentMethodPackageRules: Array<PaymentMethodPackageRule>;
  ...
  postById: Post;
  postBySlug: Post;
  postMetaKeywords: Array<PostMetaKeyword>;
  postMetaTags: Array<PostMetaTag>;
  posts: PostResponse;
  ...
  rewardsByWallets: RewardsByAddresses;
  roleById: Role;
  roles: RoleResponse;
  saleById: Sale;
  saleBySID: Sale;
...
export type QueryEmailRegionsByMemberIdArgs = {
  id: Scalars['ID']['input'];
};
...
export type QueryGiftReportArgs = {
  filter?: InputMaybe<Scalars['JSONObject']['input']>;
  page?: InputMaybe<Scalars['String']['input']>;
  sort?: InputMaybe<Scalars['String']['input']>;
};
...
export type QueryMemberStatisticWalletsByDateArgs = {
  data: IssuedAtInput;
};
...
export type RewardsByAddresses = {
  __typename?: 'RewardsByAddresses';
  rewards: Array<RewardByAddress>;
};
...
export type Team = {
  ...
  manuals: Array<Scalars['String']['output']>;
  name: Scalars['String']['output'];
  updatedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  wrangler?: Maybe<AdminInfo>;
  wranglerId?: Maybe<Scalars['String']['output']>;
};
...
export type TeamInput = {
  ...
  name: Scalars['String']['input'];
  wranglerId?: InputMaybe<Scalars['String']['input']>;
};
...
export type TeamReportItem = {
  ...
  manualMembers: Scalars['Int']['output'];
  path: Scalars['String']['output'];
  teamLeaderFullName: Scalars['String']['output'];
  teamLeaderID: Scalars['Int']['output'];
  teamLeaderId: Scalars['String']['output'];
  teamLeaderUsername: Scalars['String']['output'];
  totalLeadersUnder: Scalars['Int']['output'];
  totalTeamMember: Scalars['Int']['output'];
  weekCommission: Scalars['Int']['output'];
  weekNetPoint: Scalars['Int']['output'];
  weekTotalPoint: Scalars['Int']['output'];
  wranglerFullName?: Maybe<Scalars['String']['output']>;
  wranglerUsername?: Maybe<Scalars['String']['output']>;
};
...
export type UpdateEmailRegionInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['String']['input'];
  region: Scalars['String']['input'];
};
...
export type SubmitOrderAchPaymentWithPlaidMutationVariables = Exact<{
  data: OrderAchSubmitWithPlaidInput;
}>;
...
export type CreatePlaidLinkTokenMutation = { __typename?: 'Mutation', createPlaidLinkToken: { __typename?: 'PlaidLinkTokenResponse', requestId: string, linkToken: string, expiration: string } };
...
export type ExchangePlaidPublicTokenMutation = { __typename?: 'Mutation', exchangePlaidPublicToken: { __typename?: 'PlaidExchangeTokenResponse', itemId: string, accessToken: string, accounts: Array<{ __typename?: 'PlaidAccountWithNumbers', name: string, type: string, mask?: string | null, subtype?: string | null, accountId: string, wireRouting?: string | null, officialName?: string | null, accountNumber: string, routingNumber: string, verificationStatus?: string | null, balances: { __typename?: 'PlaidAccountBalance', limit?: number | null, current?: number | null, available?: number | null, isoCurrencyCode?: string | null }, verificationInsights?: { __typename?: 'PlaidVerificationInsights', networkStatus?: string | null, nameMatchScore?: number | null, previousReturns?: string | null, accountNumberFormat?: string | null } | null }> } };
...
export type EmailRecipientsQuery = { __typename?: 'Query', emailRecipients: { __typename?: 'EmailRecipientResponse', total?: number | null, emailRecipients: Array<{ __typename?: 'EmailRecipient', id: string, body?: string | null, sender: string, status: EmailStatus, sentAt?: any | null, subject: string, openedAt?: any | null, receiver: string, isVisible: boolean, senderName: string }> } };
...
export type EmailRecipientByIdQuery = { __typename?: 'Query', emailRecipientById: { __typename?: 'EmailRecipient', id: string, body?: string | null, sender: string, status: EmailStatus, sentAt?: any | null, subject: string, openedAt?: any | null, receiver: string, isVisible: boolean, senderName: string } };

export type EmailRegionsWithUnsubscribeQueryVariables = Exact<{ [key: string]: never; }>;


export type EmailRegionsWithUnsubscribeQuery = { __typename?: 'Query', emailRegionsWithUnsubscribe: Array<{ __typename?: 'EmailRegionWithUnsubscribe', id: string, region: string, description?: string | null, unsubscribed: boolean, unsubscribedAt?: any | null }> };

export type SubscribeEmailRegionMutationVariables = Exact<{
  subscribeEmailRegionId: Scalars['ID']['input'];
}>;


export type SubscribeEmailRegionMutation = { __typename?: 'Mutation', subscribeEmailRegion: { __typename?: 'SuccessResponse', result: SuccessResult, message?: string | null } };

export type UnsubscribeEmailRegionMutationVariables = Exact<{
  unsubscribeEmailRegionId: Scalars['ID']['input'];
}>;


export type UnsubscribeEmailRegionMutation = { __typename?: 'Mutation', unsubscribeEmailRegion: { __typename?: 'SuccessResponse', result: SuccessResult, message?: string | null } };
...
export type PaymentMethodsQuery = { __typename?: 'Query', paymentMethods: Array<{ __typename?: 'PaymentMethod', id: string, name: string, createdAt?: any | null, adminVisible: boolean, enrollmentVisible: boolean }> };

export type EnrollmentPaymentMethodsQueryVariables = Exact<{ [key: string]: never; }>;


export type EnrollmentPaymentMethodsQuery = { __typename?: 'Query', enrollmentPaymentMethods: Array<{ __typename?: 'PaymentMethod', id: string, name: string, adminVisible: boolean, enrollmentVisible: boolean }> };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PostResponse', total?: number | null, posts: Array<{ __typename?: 'Post', slug: string, title: string, content: string, _updatedAt: any, description: string, metaTitle: string, metaDescription: string, metaKeywords: Array<{ __typename?: 'PostMetaKeyword', title: string, slug: string, description?: string | null }>, metaTags: Array<{ __typename?: 'PostMetaTag', title: string, slug: string, description?: string | null }>, coverImage?: { __typename?: 'CoverImage', _type: string, asset: { __typename?: 'CoverImageAsset', _ref: string, _type: string } } | null }> } };
...
export type PostBySlugQuery = { __typename?: 'Query', postBySlug: { __typename?: 'Post', slug: string, title: string, content: string, metaTitle: string, _updatedAt: any, description: string, metaDescription: string, metaTags: Array<{ __typename?: 'PostMetaTag', slug: string, title: string, description?: string | null }>, metaKeywords: Array<{ __typename?: 'PostMetaKeyword', slug: string, title: string, description?: string | null }>, coverImage?: { __typename?: 'CoverImage', _type: string, asset: { __typename?: 'CoverImageAsset', _ref: string, _type: string } } | null } };

export type FetchMeQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchMeQuery = { __typename?: 'Query', memberMe: { __typename?: 'Member', id: string, ID?: number | null, city?: string | null, email: string, point: number, state?: string | null, avatar?: string | null, mobile: string, status: boolean, assetId?: string | null, country?: string | null, zipCode?: string | null, peerCode?: string | null, username: string, fullName: string, activated: boolean, potential: number, sponsorId?: string | null, sponsor90: number, allowState: MemberState, ethAssetId?: string | null, teamReport: Array<TeamReport>, OTPEnabled: boolean, activationTx?: string | null, teamStrategy: TeamStrategy, emailVerified: boolean, isTexitRanger: boolean, totalTXCShared: any, peerAcceptable: boolean, peerETHAddress?: string | null, primaryAddress: string, sponsorRefunded: boolean, currentHashPower: number, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefault, placementParentId?: string | null, placementPosition: PlacementPosition, placementRequested: boolean, shareIsTexitRanger: boolean, totalTXCNotReceived: any, reimbursementEnabled: boolean, orderedAvailablePoint: number, preferredContactDetail?: string | null, createdAt: any, updatedAt?: any | null, deletedAt?: any | null, groupSetting?: { __typename?: 'BasicGroupSetting', id: string, name: string, commissionDefaults: Array<CommissionDefault> } | null, commission?: { __typename?: 'CommissionInfo', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'MemberInfo', id: string, username: string, fullName: string } | null, placementParent?: { __typename?: 'MemberInfoWithPlacement', id: string, username: string, fullName: string } | null, placementChildren?: Array<{ __typename?: 'MemberInfoWithPlacement', id: string, username: string, fullName: string, placementPosition: PlacementPosition }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', id: string, note?: string | null, address: string, percent: number, memberId: string, payoutId: string, isDefault: boolean, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string } | null }> | null } };
...
export type ReimbursementByIdQueryVariables = Exact<{
  reimbursementByIdId: Scalars['Int']['input'];
}>;
...
export type FetchMemberStatisticsQuery = { __typename?: 'Query', memberStatistics: { __typename?: 'MemberStatisticsResponse', total?: number | null, memberStatistics: Array<{ __typename?: 'MemberStatistics', id: string, sent: boolean, issuedAt: any, memberId: string, txcShared: any, hashPower: number, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, statisticsId: string, statistic: { __typename?: 'Statistics', id: string, status: boolean, newBlocks: number, txcShared: any, totalBlocks: number, totalMembers: number, totalHashPower: number } }> } };
...
export type RewardsQuery = { __typename?: 'Query', rewardsByWallets: { __typename?: 'RewardsByAddresses', rewards: Array<{ __typename?: 'RewardByAddress', txc: any, address: string }> } };

export type MemberStatisticWalletsByDateQueryVariables = Exact<{
  data: IssuedAtInput;
}>;


export type MemberStatisticWalletsByDateQuery = { __typename?: 'Query', memberStatisticWalletsByDate: Array<{ __typename?: 'MemberStatisticsWallet', id: string, txc: any, address: string, issuedAt: any }> };
...
export type PromosQuery = { __typename?: 'Query', promos: { __typename?: 'PromotionResponse', total?: number | null, promotions?: Array<{ __typename?: 'Promotion', code: string, status: boolean, endDate: any, startDate: any, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, description: string }> | null } };

export type SignUpPackagesQueryVariables = Exact<{ [key: string]: never; }>;


export type SignUpPackagesQuery = { __typename?: 'Query', signUpPackages: Array<{ __typename?: 'Package', id: string, ID: number, token: number, point: number, amount: number, status: boolean, editable: boolean, freeShare: boolean, productName: string, orderVisibility: boolean, enrollVisibility: boolean }> };

export type PaymentMethodPackageRulesQueryVariables = Exact<{ [key: string]: never; }>;


export type PaymentMethodPackageRulesQuery = { __typename?: 'Query', paymentMethodPackageRules: Array<{ __typename?: 'PaymentMethodPackageRule', id: string, packageId: string, isWhiteList: boolean, paymentMethod: string }> };
...
export const SubmitOrderAchPaymentWithPlaidDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubmitOrderACHPaymentWithPlaid"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OrderACHSubmitWithPlaidInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"submitOrderACHPaymentWithPlaid"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ID"}}]}}]}}]} as unknown as DocumentNode<SubmitOrderAchPaymentWithPlaidMutation, SubmitOrderAchPaymentWithPlaidMutationVariables>;
export const CreatePlaidLinkTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreatePlaidLinkToken"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IdInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createPlaidLinkToken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestId"}},{"kind":"Field","name":{"kind":"Name","value":"linkToken"}},{"kind":"Field","name":{"kind":"Name","value":"expiration"}}]}}]}}]} as unknown as DocumentNode<CreatePlaidLinkTokenMutation, CreatePlaidLinkTokenMutationVariables>;
export const ExchangePlaidPublicTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ExchangePlaidPublicToken"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ExchangePublicTokenInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"exchangePlaidPublicToken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"itemId"}},{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"accounts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"mask"}},{"kind":"Field","name":{"kind":"Name","value":"subtype"}},{"kind":"Field","name":{"kind":"Name","value":"accountId"}},{"kind":"Field","name":{"kind":"Name","value":"wireRouting"}},{"kind":"Field","name":{"kind":"Name","value":"officialName"}},{"kind":"Field","name":{"kind":"Name","value":"accountNumber"}},{"kind":"Field","name":{"kind":"Name","value":"routingNumber"}},{"kind":"Field","name":{"kind":"Name","value":"verificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"balances"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"limit"}},{"kind":"Field","name":{"kind":"Name","value":"current"}},{"kind":"Field","name":{"kind":"Name","value":"available"}},{"kind":"Field","name":{"kind":"Name","value":"isoCurrencyCode"}}]}},{"kind":"Field","name":{"kind":"Name","value":"verificationInsights"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"networkStatus"}},{"kind":"Field","name":{"kind":"Name","value":"nameMatchScore"}},{"kind":"Field","name":{"kind":"Name","value":"previousReturns"}},{"kind":"Field","name":{"kind":"Name","value":"accountNumberFormat"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ExchangePlaidPublicTokenMutation, ExchangePlaidPublicTokenMutationVariables>;
...
export const FetchCommissionStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FetchCommissionStats"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"allFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JSONObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"pendingFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JSONObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"approvedFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JSONObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"archivedFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JSONObject"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"suspendedFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JSONObject"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"all"},"name":{"kind":"Name","value":"weeklyCommissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"allFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"pending"},"name":{"kind":"Name","value":"weeklyCommissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"pendingFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"suspended"},"name":{"kind":"Name","value":"weeklyCommissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"suspendedFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"approved"},"name":{"kind":"Name","value":"weeklyCommissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"approvedFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"archived"},"name":{"kind":"Name","value":"weeklyCommissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"archivedFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}}]}}]}}]} as unknown as DocumentNode<FetchCommissionStatsQuery, FetchCommissionStatsQueryVariables>;
...
export const EmailRegionsWithUnsubscribeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EmailRegionsWithUnsubscribe"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"emailRegionsWithUnsubscribe"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"region"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"unsubscribed"}},{"kind":"Field","name":{"kind":"Name","value":"unsubscribedAt"}}]}}]}}]} as unknown as DocumentNode<EmailRegionsWithUnsubscribeQuery, EmailRegionsWithUnsubscribeQueryVariables>;
export const SubscribeEmailRegionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubscribeEmailRegion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"subscribeEmailRegionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"subscribeEmailRegion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"subscribeEmailRegionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]} as unknown as DocumentNode<SubscribeEmailRegionMutation, SubscribeEmailRegionMutationVariables>;
export const UnsubscribeEmailRegionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnsubscribeEmailRegion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"unsubscribeEmailRegionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unsubscribeEmailRegion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"unsubscribeEmailRegionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]} as unknown as DocumentNode<UnsubscribeEmailRegionMutation, UnsubscribeEmailRegionMutationVariables>;
...
export const PaymentMethodsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PaymentMethods"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"paymentMethods"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"adminVisible"}},{"kind":"Field","name":{"kind":"Name","value":"enrollmentVisible"}}]}}]}}]} as unknown as DocumentNode<PaymentMethodsQuery, PaymentMethodsQueryVariables>;
export const EnrollmentPaymentMethodsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EnrollmentPaymentMethods"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"enrollmentPaymentMethods"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"adminVisible"}},{"kind":"Field","name":{"kind":"Name","value":"enrollmentVisible"}}]}}]}}]} as unknown as DocumentNode<EnrollmentPaymentMethodsQuery, EnrollmentPaymentMethodsQueryVariables>;
...
export const RewardsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Rewards"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"from"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Date"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"to"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Date"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rewardsByWallets"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"from"}}},{"kind":"Argument","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"to"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rewards"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"txc"}},{"kind":"Field","name":{"kind":"Name","value":"address"}}]}}]}}]}}]} as unknown as DocumentNode<RewardsQuery, RewardsQueryVariables>;
export const MemberStatisticWalletsByDateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MemberStatisticWalletsByDate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IssuedAtInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"memberStatisticWalletsByDate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"txc"}},{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"issuedAt"}}]}}]}}]} as unknown as DocumentNode<MemberStatisticWalletsByDateQuery, MemberStatisticWalletsByDateQueryVariables>;
...
export const SignUpPackagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SignUpPackages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"signUpPackages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"ID"}},{"kind":"Field","name":{"kind":"Name","value":"token"}},{"kind":"Field","name":{"kind":"Name","value":"point"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"editable"}},{"kind":"Field","name":{"kind":"Name","value":"freeShare"}},{"kind":"Field","name":{"kind":"Name","value":"productName"}},{"kind":"Field","name":{"kind":"Name","value":"orderVisibility"}},{"kind":"Field","name":{"kind":"Name","value":"enrollVisibility"}}]}}]}}]} as unknown as DocumentNode<SignUpPackagesQuery, SignUpPackagesQueryVariables>;
export const PaymentMethodPackageRulesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PaymentMethodPackageRules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"paymentMethodPackageRules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"packageId"}},{"kind":"Field","name":{"kind":"Name","value":"isWhiteList"}},{"kind":"Field","name":{"kind":"Name","value":"paymentMethod"}}]}}]}}]} as unknown as DocumentNode<PaymentMethodPackageRulesQuery, PaymentMethodPackageRulesQueryVariables>;
