...
export type EmailsQuery = { __typename?: 'Query', emails: { __typename?: 'EmailResponse', total?: number | null, emails?: Array<{ __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null }> | null } };
...
export type RecipientsQuery = { __typename?: 'Query', recipients: { __typename?: 'RecipientResponse', total?: number | null, recipients?: Array<{ __typename?: 'Recipient', updatedAt?: any | null, id: string, emailId: string, recipientId: string, isRead: boolean, isDeleted: boolean, isStarred: boolean, email?: { __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } | null, recipient?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null }> | null } };

export type TeamMembersQueryVariables = Exact<{ [key: string]: never; }>;


export type TeamMembersQuery = { __typename?: 'Query', teamMembers: Array<{ __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number }> };
...
export type EmailByIdQuery = { __typename?: 'Query', emailById: { __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } };
...
export type PaymentMethodsQuery = { __typename?: 'Query', paymentMethods: { __typename?: 'PaymentMethodResponse', total?: number | null, paymentMethods?: Array<{ __typename?: 'PaymentMethod', id: string, name: string, visible: boolean, createdAt?: any | null, defaultLink?: string | null, paymentMethodLinks?: Array<{ __typename?: 'PaymentMethodLink', id: string, link: string, packageId: string, paymentMethodId: string, package?: { __typename?: 'Package', id: string, ID: number, date: any, point: number, token: number, amount: number, status: boolean, freeShare: boolean, productName: string, enrollVisibility: boolean } | null }> | null }> | null } };

export type FetchMeQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchMeQuery = { __typename?: 'Query', memberMe: { __typename?: 'Member', id: string, ID?: number | null, city?: string | null, email: string, point: number, state?: string | null, avatar?: string | null, mobile: string, status: boolean, assetId?: string | null, balance: number, country?: string | null, zipCode?: string | null, username: string, fullName: string, sponsorId?: string | null, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, placementParentId?: string | null, placementPosition: PlacementPosition, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, groupSetting?: { __typename?: 'BasicGroupSetting', id: string, name: string, commissionDefaults: Array<CommissionDefaultEnum> } | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, state?: string | null, status: boolean, mobile: string, assetId?: string | null, balance: number, country?: string | null, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementParent?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, state?: string | null, status: boolean, mobile: string, assetId?: string | null, country?: string | null, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementChildren?: Array<{ __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, mobile: string, status: boolean, assetId?: string | null, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, secondaryAddress?: string | null, preferredContact?: string | null, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null }> | null, sales?: Array<{ __typename?: 'Sale', id: string, ID: number, status: boolean, isMetal: boolean, memberId: string, packageId: string, orderedAt: any, sponsorCnt: number, paymentMethod: string }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', id: string, note?: string | null, address: string, percent: number, memberId: string, payoutId: string, isDefault: boolean, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string } | null }> | null, communications?: Array<{ __typename?: 'CampaignMember', open: boolean, sent: boolean, body?: string | null, email: string, subject?: string | null, openTime?: any | null, sentTime?: any | null }> | null } };
...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, ID?: number | null, city?: string | null, email: string, state?: string | null, point: number, avatar?: string | null, status: boolean, mobile: string, country?: string | null, assetId?: string | null, balance: number, zipCode?: string | null, username: string, fullName: string, sponsorId?: string | null, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, placementParentId?: string | null, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, groupSetting?: { __typename?: 'BasicGroupSetting', name: string, commissionDefaults: Array<CommissionDefaultEnum> } | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, assetId?: string | null, username: string, fullName: string, teamReport: Array<TeamReport>, OTPEnabled: boolean, allowState: MemberState, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, totalIntroducers: number, preferredContact?: string | null, secondaryAddress?: string | null, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementParent?: { __typename?: 'Member', id: string, email: string, point: number, status: boolean, mobile: string, assetId?: string | null, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, totalIntroducers: number, secondaryAddress?: string | null, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, sales?: Array<{ __typename?: 'Sale', id: string, memberId: string, packageId: string, paymentMethod: string, status: boolean, isMetal: boolean, orderedAt: any }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null }> | null }> | null } };
...
export type FetchPlacementMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, email: string, status: boolean, balance: number, username: string, fullName: string, sponsorId?: string | null, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, commissionDefault: CommissionDefaultEnum, placementParentId?: string | null, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, createdAt?: any | null, placementParent?: { __typename?: 'Member', id: string, username: string, fullName: string } | null, sponsor?: { __typename?: 'Member', username: string } | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null }> | null } };
...
export type FetchMemberQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', members?: Array<{ __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, avatar?: string | null, status: boolean, mobile: string, assetId?: string | null, balance: number, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, emailVerified: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, deletedAt?: any | null, memberWallets?: Array<{ __typename?: 'MemberWallet', id: string, address: string, percent: number, memberId: string, payoutId: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, payout?: { __typename?: 'Payout', id: string, name: string, method: string, status: boolean, display: string } | null }> | null }> | null } };
...
export type LoginMutation = { __typename?: 'Mutation', memberLogin: { __typename?: 'LoginResponse', accessToken: string, status: LoginResult } };
...
export type SignUpMemberMutation = { __typename?: 'Mutation', signUpMember: { __typename?: 'Member', id: string, email: string, username: string } };
...
export type SendEmailVerificationMutation = { __typename?: 'Mutation', sendEmailVerification: { __typename?: 'SuccessResponse', result: SuccessResult, message?: string | null } };
...
export type TeamCommissionsQuery = { __typename?: 'Query', teamCommissions: { __typename?: 'WeeklyCommissionResponse', total?: number | null, weeklyCommissions?: Array<{ __typename?: 'WeeklyCommission', id: string, ID: number, begL: number, begR: number, newL: number, newR: number, maxL: number, maxR: number, endL: number, endR: number, pkgL: number, pkgR: number, status: ConfirmationStatus, shortNote?: string | null, commission: number, weekStartDate: any, member?: { __typename?: 'Member', assetId?: string | null, username: string } | null }> | null } };
