...
export type ResetTokenVerifyMutation = {
  __typename?: 'Mutation';
  resetTokenVerify: { __typename?: 'VerifyTokenResponse'; email: string; token: string };
};
...
export type UpdateMemberMutation = {
  ...
  updateMember: {
    ...
    memberWallets?: Array<{
      ...
      address: string;
      percent: number;
      payout?: { __typename?: 'Payout'; method: string; display: string } | null;
    } | null> | null;
  };
};
...
export type ResetPasswordRequestMutation = {
  __typename?: 'Mutation';
  resetPasswordRequest: { __typename?: 'SuccessResponse'; message?: string | null; result: string };
};
...
export type ResetPasswordByTokenMutation = {
  __typename?: 'Mutation';
  resetPasswordByToken: { __typename?: 'SuccessResponse'; message?: string | null; result: string };
};
  ...
  rewardsByWallets: {
    ...
    rewards: Array<{
      ...
      wallet: {
        ...
        address: string;
        percent: number;
        payout?: { __typename?: 'Payout'; name: string; method: string } | null;
      };
    }>;
  };
};
...
export type DailyRewardsQuery = {
  ...
  dailyRewards: {
    ...
    rewards: Array<{
      ...
      day: any;
      totalTxc: any;
      rewardsByWallet: Array<{
        __typename?: 'RewardByWallet';
        txc: any;
        wallet: {
          __typename?: 'MemberWallet';
          address: string;
          payout?: { __typename?: 'Payout'; method: string } | null;
        };
      }>;
    }>;
  };
...
export type MemberStatisticsWalletsQuery = {
  __typename?: 'Query';
  memberStatisticsWallets: {
    ...
    memberStatisticsWallets?: Array<{
      ...
      txc: any;
      issuedAt: any;
      memberWallet?: { __typename?: 'MemberWallet'; address: string } | null;
      memberStatistic?: {
        __typename?: 'MemberStatistics';
        hashPower: number;
        percent: number;
...
export type LoginMutation = {
  __typename?: 'Mutation';
  memberLogin: { __typename?: 'MemberLoginResponse'; accessToken: string };
};
...
export type SignUpMemberMutation = {
  __typename?: 'Mutation';
  signUpMember: { __typename?: 'Member'; email: string; username: string; id: string };
};
...
export type SendEmailVerificationMutation = {
  __typename?: 'Mutation';
  sendEmailVerification: { __typename?: 'EmailVerificationResponse'; token: string };
};
...
export type EmailVerifyMutation = {
  __typename?: 'Mutation';
  emailVerify: { __typename?: 'SuccessResponse'; message?: string | null; result: string };
};
...
export const ResetTokenVerifyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ResetTokenVerify' },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<ResetTokenVerifyMutation, ResetTokenVerifyMutationVariables>;
...
export const FetchMemberDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FetchMember' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
...
} as unknown as DocumentNode<FetchMemberQuery, FetchMemberQueryVariables>;
...
} as unknown as DocumentNode<ResetPasswordRequestMutation, ResetPasswordRequestMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ResetPasswordByToken' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
...
} as unknown as DocumentNode<ResetPasswordByTokenMutation, ResetPasswordByTokenMutationVariables>;
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'memberStatisticsWallets' },
                              selectionSet: {
                                kind: 'SelectionSet',
                                selections: [
                                  { kind: 'Field', name: { kind: 'Name', value: 'id' } },
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'rewardsByWallets' },
            arguments: [
              {
                kind: 'Argument',
...
export const DailyRewardsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DailyRewards' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'from' } },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rewardsByWallet' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'txc' } },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'totalTxc' } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<DailyRewardsQuery, DailyRewardsQueryVariables>;
export const MemberStatisticsWalletsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'memberWallet' },
                        selectionSet: {
                          kind: 'SelectionSet',
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'memberStatistic' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'hashPower' } },
...
} as unknown as DocumentNode<MemberStatisticsWalletsQuery, MemberStatisticsWalletsQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'MemberLoginInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'memberLogin' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'data' },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'SignupFormInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<SignUpMemberMutation, SignUpMemberMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'EmailVerify' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'data' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'EmailVerificationInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<EmailVerifyMutation, EmailVerifyMutationVariables>;
