...
export type FetchPlacementMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, email: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, sponsorId?: string | null, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, commissionDefault: CommissionDefaultEnum, placementParentId?: string | null, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, createdAt?: any | null, placementParent?: { __typename?: 'Member', id: string, username: string, fullName: string } | null, sponsor?: { __typename?: 'Member', username: string } | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null }> | null } };
