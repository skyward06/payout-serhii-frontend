...
export type Statistics = {
  ...
  issuedAt: Scalars['DateTimeISO']['output'];
  newBlocks: Scalars['Float']['output'];
  rewardedTXC: Scalars['BigInt']['output'];
  status: Scalars['Boolean']['output'];
...
export type WeeklyCommissionsQuery = { __typename?: 'Query', weeklyCommissions: { __typename?: 'BasicWeeklyCommissionResponse', total?: number | null, weeklyCommissions: Array<{ __typename?: 'BasicWeeklyCommission', id: string, ID: number, begL: number, begR: number, newL: number, newR: number, maxL: number, maxR: number, endL: number, endR: number, pkgL: number, pkgR: number, note?: string | null, status: CommissionStatus, hasUSDC: boolean, username: string, fullName: string, memberId: string, createdAt: any, shortNote?: string | null, commission: number, commissionType: CommissionType, weekStartDate: any, paymentMethod: CommissionDefault }> } };
...
export type RewardQuery = { __typename?: 'Query', statistics: { __typename?: 'StatisticsResponse', total?: number | null, statistics: Array<{ __typename?: 'Statistics', id: string, to: any, from: any, status: boolean, issuedAt: any, txcShared: any, newBlocks: number, totalBlocks: number, rewardedTXC: any, totalMembers: number, totalHashPower: number }> } };
...
export type TxcMemberStatisticsQuery = { __typename?: 'Query', memberStatistics: { __typename?: 'MemberStatisticsResponse', total?: number | null, memberStatistics: Array<{ __typename?: 'MemberStatistics', id: string, hashPower: number, txcShared: any, issuedAt: any, percent: number, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, member: { __typename?: 'Member', username: string, email: string, assetId?: string | null } }> } };
