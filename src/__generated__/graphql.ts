...
export type Mutation = {
  __typename?: 'Mutation';
  addCardPointCurrentWeek: SuccessResponse;
...
export type MutationAddCardPointCurrentWeekArgs = {
  data: PointOperationInput;
};
...
export type MutationSetCardPointCurrentWeekArgs = {
  data: PointOperationInput;
};
...
export type MutationUpdateTxcRequestArgs = {
  data: UpdateTxcRequestInput;
};
...
export type PointOperationInput = {
  id: Scalars['ID']['input'];
  point: Scalars['Int']['input'];
  position?: InputMaybe<PlacementPosition>;
};
...
export type TxcRequestResponse = {
  ...
  total?: Maybe<Scalars['Int']['output']>;
  txcRequests?: Maybe<Array<BasicTxcRequest>>;
};
...
export type FetchMeQuery = { __typename?: 'Query', memberMe: { __typename?: 'Member', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, ID?: number | null, city?: string | null, email: string, point: number, state?: string | null, avatar?: string | null, mobile: string, status: boolean, assetId?: string | null, country?: string | null, zipCode?: string | null, username: string, fullName: string, sponsorId?: string | null, allowState: MemberState, ethAssetId?: string | null, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, isTexitRanger: boolean, peerAcceptable: boolean, peerETHAddress?: string | null, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementParentId?: string | null, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, placementRequested: boolean, preferredContactDetail?: string | null, memberWallets?: Array<{ __typename?: 'MemberWallet', id: string, memberId: string, note?: string | null, address: string, percent: number, payoutId: string, isDefault: boolean }> | null, communications?: Array<{ __typename?: 'CampaignMember', body?: string | null, open: boolean, sent: boolean, email: string, sender: string, subject?: string | null, openTime?: any | null, sentTime?: any | null }> | null } };
...
export type OrderByIdQuery = { __typename?: 'Query', orderById: { __typename?: 'Order', id: string, ID: number, status: OrderStatus, expiredAt: any, paidBalance: any, paymentToken?: PaymentToken | null, paymentChain?: PaymentChain | null, paymentAddress?: string | null, requiredBalance?: any | null } };
...
export type FetchMyProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchMyProfileQuery = { __typename?: 'Query', memberMe: { __typename?: 'Member', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, ID?: number | null, city?: string | null, email: string, point: number, state?: string | null, avatar?: string | null, mobile: string, status: boolean, assetId?: string | null, country?: string | null, zipCode?: string | null, username: string, fullName: string, sponsorId?: string | null, allowState: MemberState, ethAssetId?: string | null, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, isTexitRanger: boolean, peerAcceptable: boolean, peerETHAddress?: string | null, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementParentId?: string | null, placementPosition: PlacementPosition, cmnCalculatedWeeks: number, placementRequested: boolean, preferredContactDetail?: string | null, groupSetting?: { __typename?: 'BasicGroupSetting', id: string, name: string, commissionDefaults: Array<CommissionDefaultEnum> } | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, state?: string | null, status: boolean, mobile: string, assetId?: string | null, country?: string | null, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, isTexitRanger: boolean, peerAcceptable: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, placementRequested: boolean, cmnCalculatedWeeks: number, preferredContactDetail?: string | null } | null, placementParent?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, state?: string | null, status: boolean, mobile: string, assetId?: string | null, country?: string | null, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, isTexitRanger: boolean, emailVerified: boolean, syncWithSendy: boolean, peerAcceptable: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, placementRequested: boolean, cmnCalculatedWeeks: number, preferredContactDetail?: string | null } | null, placementChildren?: Array<{ __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, mobile: string, status: boolean, assetId?: string | null, username: string, fullName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, isTexitRanger: boolean, peerAcceptable: boolean, primaryAddress: string, secondaryAddress?: string | null, preferredContact?: string | null, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, placementRequested: boolean, cmnCalculatedWeeks: number, preferredContactDetail?: string | null }> | null, sales?: Array<{ __typename?: 'Sale', id: string, ID: number, status: boolean, isMetal: boolean, memberId: string, packageId: string, orderedAt: any, sponsorCnt: number, paymentMethod: string }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', id: string, note?: string | null, address: string, percent: number, memberId: string, payoutId: string, isDefault: boolean, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string } | null }> | null, communications?: Array<{ __typename?: 'CampaignMember', open: boolean, sent: boolean, body?: string | null, email: string, sender: string, subject?: string | null, openTime?: any | null, sentTime?: any | null }> | null, setting?: { __typename?: 'Setting', id: string, memberId: string, communication: boolean } | null } };
...
export type FetchMemberStatsQuery = { __typename?: 'Query', all: { __typename?: 'BasicMemberResponse', total?: number | null }, inactive: { __typename?: 'BasicMemberResponse', total?: number | null } };
...
export type SearchMembersQuery = { __typename?: 'Query', searchMembers: Array<{ __typename?: 'BasicMemberInfo', id: string, ID: number, email: string, mobile: string, username: string, fullName: string }> };
...
export type RewardQuery = { __typename?: 'Query', statistics: { __typename?: 'StatisticsResponse', total?: number | null, statistics?: Array<{ __typename?: 'Statistics', id: string, to: any, from: any, status: boolean, issuedAt: any, txcShared: any, newBlocks: number, totalBlocks: number, totalMembers: number, totalHashPower: number, memberStatistics?: Array<{ __typename?: 'MemberStatistics', txcShared: any, memberStatisticsWallets?: Array<{ __typename?: 'MemberStatisticsWallet', id: string }> | null }> | null }> | null } };
...
export type RemoveMemberStatisticsByStatisticsIdMutationVariables = Exact<{
  data: IdInput;
}>;


export type RemoveMemberStatisticsByStatisticsIdMutation = { __typename?: 'Mutation', removeMemberStatisticsByStaitisId: { __typename?: 'ManySuccessResponse', count: number } };
...
export type RewardByWalletQueryVariables = Exact<{
  from: Scalars['DateTimeISO']['input'];
  to: Scalars['DateTimeISO']['input'];
}>;


export type RewardByWalletQuery = { __typename?: 'Query', rewardsByWallets: { __typename?: 'RewardsByWallets', rewards: Array<{ __typename?: 'RewardByWallet', txc: any, wallet: { __typename?: 'MemberWallet', id: string, address: string, percent: number, payout?: { __typename?: 'Payout', name: string, method: string } | null } }> } };
...
export type TxcRequestsQuery = { __typename?: 'Query', txcRequests: { __typename?: 'TXCRequestResponse', total?: number | null, txcRequests?: Array<{ __typename?: 'BasicTXCRequest', id: string, ID: number, amount: number, status: TxcRequestStatus, memberId: string, username?: string | null, fullName?: string | null, createdAt: any, walletAddress: string }> | null } };
...
export type TeamCommissionsQuery = { __typename?: 'Query', teamCommissions: { __typename?: 'BasicWeeklyCommissionResponse', total?: number | null, weeklyCommissions?: Array<{ __typename?: 'BasicWeeklyCommission', id: string, ID: number, begL: number, begR: number, newL: number, newR: number, maxL: number, maxR: number, endL: number, endR: number, pkgL: number, pkgR: number, note?: string | null, status: ConfirmationStatus, username: string, fullName: string, memberId: string, createdAt: any, shortNote?: string | null, commission: number, weekStartDate: any, paymentMethod: CommissionDefaultEnum }> | null } };
...
export const RemoveMemberStatisticsByStatisticsIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveMemberStatisticsByStatisticsId"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IDInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeMemberStatisticsByStaitisId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]} as unknown as DocumentNode<RemoveMemberStatisticsByStatisticsIdMutation, RemoveMemberStatisticsByStatisticsIdMutationVariables>;
...
export const RewardByWalletDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RewardByWallet"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"from"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTimeISO"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"to"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTimeISO"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rewardsByWallets"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"from"}}},{"kind":"Argument","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"to"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rewards"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"txc"}},{"kind":"Field","name":{"kind":"Name","value":"wallet"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"percent"}},{"kind":"Field","name":{"kind":"Name","value":"payout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"method"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<RewardByWalletQuery, RewardByWalletQueryVariables>;
