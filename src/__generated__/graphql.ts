...
export type OrderByIdQuery = { __typename?: 'Query', orderById: { __typename?: 'Order', id: string, ID: number, status: OrderStatus, expiredAt: any, paidBalance: any, paymentToken?: PaymentToken | null, paymentChain?: PaymentChain | null, paymentAddress?: string | null, requiredBalance?: any | null, availablePaymentMethods: Array<{ __typename?: 'OrderPaymentMethod', isP2P: boolean, paymentChain?: PaymentChain | null, paymentToken?: PaymentToken | null }> } };
