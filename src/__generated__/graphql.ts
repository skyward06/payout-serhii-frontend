...
export type EmailsQuery = { __typename?: 'Query', emails: { __typename?: 'EmailResponse', total?: number | null, emails?: Array<{ __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null }> | null } };
...
export type RecipientsQuery = { __typename?: 'Query', recipients: { __typename?: 'RecipientResponse', total?: number | null, recipients?: Array<{ __typename?: 'Recipient', updatedAt?: any | null, id: string, emailId: string, recipientId: string, isRead: boolean, isDeleted: boolean, isStarred: boolean, email?: { __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } | null, recipient?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null }> | null } };

export type TeamMembersQueryVariables = Exact<{ [key: string]: never; }>;


export type TeamMembersQuery = { __typename?: 'Query', teamMembers: Array<{ __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, cmnCalculatedWeeks: number }> };
...
export type EmailByIdQuery = { __typename?: 'Query', emailById: { __typename?: 'Email', id: string, to: string, body: string, subject: string, isDraft: boolean, senderId: string, isDeleted: boolean, updatedAt?: any | null, sender?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: TeamReport, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, cmnCalculatedWeeks: number } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } };
...
export type FetchMeQuery = { __typename?: 'Query', memberMe: { __typename?: 'Member', id: string, balance: number, username: string, fullName: string, email: string, point: number, groupName: string, allowState: MemberState, primaryAddress: string, secondaryAddress?: string | null, ID?: number | null, assetId?: string | null, mobile: string, city?: string | null, emailVerified: boolean, totalIntroducers: number, status: boolean, country?: string | null, state?: string | null, syncWithSendy: boolean, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, zipCode?: string | null, sponsorId?: string | null, teamReport: TeamReport, teamStrategy: TeamStrategy, placementParentId?: string | null, placementPosition: PlacementPosition, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, balance: number, username: string, fullName: string, email: string, point: number, allowState: MemberState, groupName: string, emailVerified: boolean, totalIntroducers: number, status: boolean, teamReport: TeamReport, primaryAddress: string, secondaryAddress?: string | null, mobile: string, ID?: number | null, assetId?: string | null, syncWithSendy: boolean, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, state?: string | null, country?: string | null, placementPosition: PlacementPosition, teamStrategy: TeamStrategy, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementParent?: { __typename?: 'Member', id: string, email: string, point: number, state?: string | null, status: boolean, mobile: string, ID?: number | null, assetId?: string | null, groupName: string, allowState: MemberState, teamReport: TeamReport, country?: string | null, balance: number, username: string, fullName: string, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, totalIntroducers: number, secondaryAddress?: string | null, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, placementPosition: PlacementPosition, teamStrategy: TeamStrategy, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementChildren?: Array<{ __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, ID?: number | null, assetId?: string | null, allowState: MemberState, teamReport: TeamReport, balance: number, username: string, fullName: string, groupName: string, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, secondaryAddress?: string | null, preferredContact?: string | null, totalIntroducers: number, placementPosition: PlacementPosition, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, teamStrategy: TeamStrategy, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null }> | null, sales?: Array<{ __typename?: 'Sale', id: string, ID: number, memberId: string, packageId: string, paymentMethod: string, status: boolean, orderedAt: any, freeShareSale: boolean }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, note?: string | null, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null }> | null } };
...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, teamReport: TeamReport, balance: number, username: string, fullName: string, email: string, point: number, primaryAddress: string, secondaryAddress?: string | null, ID?: number | null, assetId?: string | null, mobile: string, city?: string | null, country?: string | null, emailVerified: boolean, totalIntroducers: number, status: boolean, state?: string | null, allowState: MemberState, syncWithSendy: boolean, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, zipCode?: string | null, sponsorId?: string | null, placementParentId?: string | null, placementPosition: PlacementPosition, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, balance: number, username: string, fullName: string, email: string, emailVerified: boolean, totalIntroducers: number, status: boolean, point: number, teamReport: TeamReport, allowState: MemberState, syncWithSendy: boolean, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, primaryAddress: string, secondaryAddress?: string | null, mobile: string, assetId?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, placementParent?: { __typename?: 'Member', id: string, teamReport: TeamReport, balance: number, username: string, fullName: string, email: string, emailVerified: boolean, totalIntroducers: number, status: boolean, point: number, allowState: MemberState, syncWithSendy: boolean, preferredContact?: string | null, preferredContactDetail?: string | null, cmnCalculatedWeeks: number, primaryAddress: string, secondaryAddress?: string | null, mobile: string, assetId?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, sales?: Array<{ __typename?: 'Sale', id: string, memberId: string, packageId: string, paymentMethod: string, status: boolean, orderedAt: any }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null }> | null }> | null } };
...
export type FetchMemberQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', members?: Array<{ __typename?: 'Member', id: string, teamReport: TeamReport, balance: number, username: string, fullName: string, email: string, point: number, emailVerified: boolean, totalIntroducers: number, status: boolean, mobile: string, primaryAddress: string, secondaryAddress?: string | null, ID?: number | null, allowState: MemberState, assetId?: string | null, deletedAt?: any | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null }> | null }> | null } };
