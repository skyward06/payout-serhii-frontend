...
export function AboutTestimonials() {
  ...
  const renderLink = (
    <Button
      ...
      href="https://texitcoin.org/News-and-Updates.html"
      target="_blank"
    >
    ...
    <Box sx={{ maxWidth: { md: 360 }, textAlign: { xs: 'center', md: 'unset' } }}>
      ...
      <m.div variants={varFade().inUp}>
        <Typography sx={{ color: 'common.white' }}>
          Our community of miners is at the heart of TEXITcoin. We&apos;re building a robust network
          of individuals committed to honest money and financial sovereignty. Join us in creating a
          decentralized future for Texas and beyond.
        </Typography>
      </m.div>
